...
export default function PortfolioPage() {
    return (
        <main className="pt-32 pb-20 bg-background-light min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <span className="text-secondary font-bold tracking-wider uppercase text-sm">Nossos Projetos</span>
